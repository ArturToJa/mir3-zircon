...
namespace Library
{
    ...
    public enum MagicType
    {
        ...
        EnhancedScorchedEarth = 568,
        AwakenedScorchedEarth = 569,
        EnhancedFireWall = 570,
        AwakenedFireWall = 571,
        AwakenedAsteroid = 572,
        AwakenedIceBlades = 573,
        AwakenedFrozenEarth = 574,
        EnhancedIceStorm = 575,
        AwakenedIceStorm = 576,
        AwakenedChainLightning = 577,
        EnhancedThunderBeam = 578,
        AwakenedThunderBeam = 579,
        EnhancedElectricShock = 580,
        AwakenedElectricShock = 581,
        AwakenedCyclone = 582,
        EnhancedBlowEarth = 583,
        AwakenedBlowEarth = 584,

        EnhancedMagicResistance = 585,
        AwakenedMagicResistance = 586,

        EnhancedTempest = 587,
        AwakenedTempest = 588,
        EnhancedRenounce = 589,
        EnhancedTeleportation = 590,
        AwakenedTeleportation = 591,
        EnhancedGeoManipulation = 592,
        AwakenedGeoManipulation = 593,
        EnhancedExpelUndead = 594,
        AwakenedExpelUndead = 595,
        EnhancedMagicShield = 596,
        AwakenedMagicShield = 597,

        EnhancedResilience = 598,
        AwakenedResilience = 599,
        EnhancedTaoCombatKick = 600,
        AwakenedTaoCombatKick = 601,
        EnhancedElementalSuperiority = 602,
        AwakenedElementalSuperiority = 603,
        ...
        EnhancedInfection = 613,
        AwakenedInfection = 614,
        EnhancedEmpoweredEvilSlayer = 615,
        AwakenedEmpoweredEvilSlayer = 616,
        EnhancedEmpoweredPoisonDust = 617,
        AwakenedEmpoweredPoisonDust = 618,
        EnhancedEmpoweredTaoExplosion = 619,
        AwakenedEmpoweredTaoExplosion = 620,
